            ...
            <div class="about-intro-wrap pull-left">
                ...
                <div class="container">
                    <div class="intro-content-wrap col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left no-pad" style="visibility: visible;"> <span class="fl">-</span>
                        ...
                        <div class="clearfix"></div>
                        <div class="text-indent"> <span class="fl second_level_hypen">•</span>
                            <p class="text_1 fl black_italic"><b>Drug development</b> – where medicinal/synthetic/analytical aspects of chemistry combine sequentially and iteratively with disciplines such as pharmacology, biology, toxicology and clinical sciences to produce a drug that is sufficiently effective, safe, stable and efficient to produce for clinical use</p>
                            <div class="clearfix"></div> <span class="fl second_level_hypen">•</span>
                            <p class="text_1 fl black_italic"> <b>Botanical classification</b> – a field that was transformed in the 20<sup>th</sup> century by the importation of chemistry techniques of isolation and structure elucidation to enable plants to be characterised and their classifications determined according to their chemical constituents, resulting in the emergence of ‘phytochemistry’ and ‘chemical plant taxonomy’.</p>
                            <div class="clearfix"></div> <span class="fl second_level_hypen">•</span>
                            <p class="text_1 fl black_italic"><b>Climate change science</b></p>
                            <div class="clearfix"></div> <span class="fl second_level_hypen">•</span>
                            <p class="text_1 fl black_italic"><b>Semiconductors</b> – the development of which as the basis of modern computers has depended on an interdisciplinary approach to developing new materials with specific physical properties.</p>
                            <div class="clearfix"></div>
                        </div> <span class="fl">-</span>
                        <p class="text_1 fl"><b>Transdisciplinary:</b> beyond interdisciplinary (which still implies the autonomy of subjects working in cooperation), creating a new synthesis of chemistry and other subjects in which knowledge, methods and solutions are developed holistically: recognizing that valuable knowledge can be found in the spaces between defined disciplines, addressing the complexity of problems and the diversity of perceptions of them, and requiring not only in-depth knowledge and know-how of the disciplines involved, but also skills in moderation, mediation, association and transfer<sup>2,3</sup> It has been argued<sup>4</sup> that the shift from disciplinary to transdisciplinary research corresponds to a transition from compartmentalised, corrective, problem solving approaches to systemic, preventive ones. The term ‘convergence’ has also been used to describe the approach to problem solving that cuts across disciplinary boundaries and integrates knowledge, tools, and ways of thinking from diverse disciplines.<sup>5</sup></p>
                        <div class="clearfix"></div>
                        ...
                        <p class="text_1">In an analysis of the field, four criteria were suggested<sup>6</sup> for transdisciplinary research: (1) Problem orientation: research questions derived from "real-world" problems. (2) A suitable definition of sub-problems which is a prerequisite for the integration of the results. (3) Free choice of scientific methods adequate for each of the sub-problems. (4) Close relations between the sub-problems are crucial for the development of an overall solution. Once there is recognition of the real-world problem and the scientific problem is defined independently of disciplines, they propose a four-stage process of problem solving: (1) Understanding of the problem: Identification and analysis of main questions. (2) Separation of the problem into fields of application of different methods (sub-problems). (3) Solution of the sub-problems with mutual connections. (4) Integration of the results into a solution of the entire problem – with the cross-disciplinary results leading to application of the proposed solutions. Examples include</p>
                        <div class="clearfix"></div>
                        <div class="text-indent style_pad">
                            <ul>
                                <li class="text_1 list_style_add"> In studies on environmental and ecological chemistry, the inputs of political and social as well as science knowledge are critical.<sup>7,8</sup></li>
                            </ul>
                            <ul>
                                <li class="text_1 list_style_add"> The series of conferences on transdisciplinary amino acid research initiated in 1991 illustrate how a theme unifying chemistry, biology and medicine can drive new breakthroughs in knowledge and applications.<sup>9</sup></li>
                            </ul>
                            <ul>
                                <li class="text_1 list_style_add"> Transdisciplinary research involving chemistry has been adopted in many areas including smart energy;<sup>10</sup> chemistry/microbiology;<sup>11</sup> life processes;<sup>12</sup> cancer;<sup>13</sup> tobacco harm reduction;<sup>14</sup> bio-manufacturing, cardiovascular diseases, the grape and wine industry, child development and water supply;<sup>15</sup> radiation biology;<sup>16</sup> chemical biology;<sup>17</sup> volcanic plumes;<sup>18</sup> silicifying organisms;<sup>19</sup> and soil science and its applications in the dairy industry.<sup>20</sup></li>
                            </ul>
                        </div>
                        </br>
                        <div>
                        ...
                        <p class="text_1 no-pad"><a href="http://europepmc.org/abstract/med/18619397" target="_blank">14. K.G. Provan, P.I. Clark, T.R. Huerta. Transdiciplinarity among tobacco harm reduction researchers: A network analytic approach.</a></p>
                        ...
                        <p class="text_1 no-pad"><a href="http://blog.renewableenergyworld.com/ugc/blogs/2011/05/new-tools-let-chemistry-solve-the-energy-crisis.html" target="_blank">21. D. Blankenhorn. New Tools Let Chemistry Solve the Energy Crisis. RenewableEnergyWorld.com 16 May 2011.</a></p>
                    </div>
                </div>
            </div>
        </div>
