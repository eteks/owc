                    		...
                    		<nav class="navbar navbar-default" role="navigation">
                      			<div class="row">
	                                ...
	                                <div class="logo_with_content">
			                        	...
			                        	<h1 class="logo_subtitle_under hidden-sm hidden-md hidden-xs">ONE-WORLD CHEMISRY</h1>
							        	<h2 class="logo_subtitle hidden-sm hidden-md hidden-xs">Systems thinking to shape the chemical sciences for sustainable development</h2>
							        	<h3 class="logo_subtitle_under hidden-sm hidden-md hidden-xs">An initiative of the International Organization for Chemical Sciences in Development</h3>
				                    ...
				                    <div class="collapse navbar-collapse no-pad nav_center " id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav navbar-right no-margin">
				                            <li class="<?php if(basename($_SERVER['PHP_SELF']) == 'index.php' || basename($_SERVER['PHP_SELF']) == 'sitemap.php') echo "active"; ?>"><a href="index.php" class="dropdown-toggle" data-toggle="dropdown" target="_blank"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
				                            ...
				                            <li class="dropdown <?php if(basename($_SERVER['PHP_SELF']) == 'system.php' || basename($_SERVER['PHP_SELF']) == 'cross.php') echo "active"; ?>"><a href="system.php" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-lightbulb-o" aria-hidden="true"></i> Systems thinking<b class="icon-angle-down"></b></a>
				                                <ul class="dropdown-menu">
				                            ...
				                            <li class="dropdown <?php if(basename($_SERVER['PHP_SELF']) == 'literature.php' ) echo "active"; ?>"><a href="literature.php" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-book" aria-hidden="true"></i>  Resources<b class="icon-angle-down"></b></a>
				                                <ul class="dropdown-menu">
				                                    <li><a href="literature.php">Literature Resources</a></li>
				                                    
				                                </ul>
				                            </li>
				                            <li class="dropdown <?php if(basename($_SERVER['PHP_SELF']) == 'contact.php' || basename($_SERVER['PHP_SELF']) == 'iocd.php' ) echo "active"; ?>"><a href="contact.php" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope" aria-hidden="true"></i> Contact us<b class="icon-angle-down"></b></a>
				                                <ul class="dropdown-menu ">
