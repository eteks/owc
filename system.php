    			...
    			<div class="about-intro-wrap pull-left">
    				<div class="bread-crumb-wrap ibc-wrap-4">
						...
						<!--Title / Beadcrumb-->
				         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
				            	<div class="bread-heading"><h1>The need for systems thinking in the chemical sciences</h1></div>
				    ...
				    <div class="container paraa">
				        <div class="text-indent content_with_hypen col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left" style="visibility: visible;">
				            ...
				            <ul class="style_pad"><li class="list_style_add system"> After use, the products or their consequent waste must be disposed of or recycled efficiently,  cleanly, safely and sustainably. </li></ul>
				            <ul class="style_pad"><li class="list_style_add system"> At every stage, the ‘chemistry system’ in which the product is manufactured, used and disposed of is interacting with the ‘human system’. Actions involving chemistry don’t just ‘happen’: they occur because of decisions that people take, individually or collectively. These decisions may result from diverse human motivations, including curiosity and aspirations for success, wealth, power or pleasure; and they are influenced by legal constraints, by societal pressures and by movements for the advance of collective local and global goals. </li></ul>
				    ...
				    <div class="container">
				        <div class="col-md-12 col-xs-12 col-sm-12 pull-left full-content">
				         ...
				         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 image_centering">
		                    <a class="magnify_popup " href="images/life_cycle.png"><img class="img-responsive" src="images/life_cycle.png" alt="Life Cycle of a Chemical Product">
