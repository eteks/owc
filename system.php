            ...
            <div class="about-intro-wrap pull-left">
                ...
                <div class="container paraa">
                    <div class="text-indent content_with_hypen col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left" style="visibility: visible;">
                        <ul class="style_pad">
                            <li class="list_style_add system">Chemical reactions, whether they are small-scale laboratory or large-scale manufacturing processes, generate waste materials that need to be managed – including containment, disposal and recycling – in a safe and sustainable manner.</li>
                        </ul>
                        <ul class="style_pad">
                            <li class="list_style_add system">The raw materials used, whether they are natural resources or other manufactured intermediates, must be sourced efficiently, cleanly, safely and sustainably.</li>
                        </ul>
                        <ul class="style_pad">
                            <li class="list_style_add system"> The products of manufacture may find very diverse uses, including household, medical, industrial and agricultural applications in which they come into contact with people, animals and the environment – and they must therefore be tested to ensure their biological and environmental safety.</li>
                        </ul>
                        <ul class="style_pad">
                            <li class="list_style_add system"> After use, the products or their consequent waste must be disposed of or recycled efficiently, cleanly, safely and sustainably.</li>
                        </ul>
                        <ul class="style_pad">
                            <li class="list_style_add system"> At every stage, the ‘chemistry system’ in which the product is manufactured, used and disposed of is interacting with the ‘human system’. Actions involving chemistry don’t just ‘happen’: they occur because of decisions that people take, individually or collectively. These decisions may result from diverse human motivations, including curiosity and aspirations for success, wealth, power or pleasure; and they are influenced by legal constraints, by societal pressures and by movements for the advance of collective local and global goals.</li>
                        </ul>
                        <ul class="style_pad">
                            <li class="list_style_add system"> The ‘chemistry system’ therefore interlinks with a host of other overlapping systems including the biosphere, the environment, human and animal health, economics, politics, psychology and the law.</li>
                        </ul>
                    </div>
                </div>
                <br>
                <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 image_centering">
                        <a class="magnify_popup " href="images/life_cycle.png"><img class="img-responsive" src="images/life_cycle.png" alt="Life Cycle of a Chemical Product"></div>
                </div>
            </div>
        </div>
    </section>
